    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
              action="<?php echo base_url(); ?>lineas/update" method="post">
        ...
        <input type="hidden" name="id_linea" value="<?php echo $linea->id_linea ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="nombre_linea" name="nombre_linea" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $linea->nombre_linea ?>">
            </div>
          </div>
